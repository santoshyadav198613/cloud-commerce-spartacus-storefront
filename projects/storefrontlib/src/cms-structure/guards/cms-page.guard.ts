  ...
  private resolveCmsPageLogic(
    ...
    return this.cmsService.getPageComponentTypes(pageContext).pipe(
      ...
      map(([canActivate, componentTypes]) => {
        // We take pageLabel from the backend response (not from initial pageContext.id),
        // because backend may respond with shorter page label than the current url.
        // It's the case when we enter a deep link to a CMS-component driven child route.
        const pageLabel = pageData.pageLabel;
