...
describe('Product Interests Actions', () => {
  ...
  describe('DeleteProductInterests Actions', () => {
    it('should be able to create the action', () => {
      ...
      const action = new UserActions.DeleteProductInterests(payload);
      expect({ ...action }).toEqual({
        type: UserActions.DELETE_PRODUCT_INTERESTS,
        payload: payload,
        meta: loadMeta(PRODUCT_INTERESTS),
      });
    });
  ...
  describe('DeleteProductInterestsSuccess Actions', () => {
    it('should be able to create the action', () => {
      ...
      const action = new UserActions.DeleteProductInterestsSuccess(payload);
      expect({ ...action }).toEqual({
  ...
  describe('DeleteProductInterestsFail Actions', () => {
    it('should be able to create the action', () => {
      ...
      const action = new UserActions.DeleteProductInterestsFail(error);
      expect({ ...action }).toEqual({
        type: UserActions.DELETE_PRODUCT_INTERESTS_FAIL,
        payload: error,
